...
import { MessageSquare, Send, Loader2, User, BrainCircuit, X, CornerDownLeft } from "lucide-react";
                ...
                <ScrollArea className="flex-1" ref={scrollAreaRef}>
                    ...
                    {messages.length === 0 && (
                        <div className="text-center text-muted-foreground pt-16">
                            ...
                            <p className="mt-4 text-sm">Start the conversation! Ask me anything about your career.</p>
                        </div>
                    )}
